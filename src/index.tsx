...
// Ваша задача вместо XXX написать код, Ответ: setBalance(1000)
...
const SecretToken = () => {
	...
	const token = '/secret/JIUzI1NiIsInR5cCI6IkpXVCJ9'
...
// ❗В качестве переменной используйте значение
...
// Помогите разработчику исправить код так, чтобы успешно залогиниться (и редиректнуться на Profile) Ответ: onClick={()=>dispatch(loginTC(email,password))}
